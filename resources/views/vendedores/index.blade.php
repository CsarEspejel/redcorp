...
<nav class="navbar navbar-expand-lg navbar-light bg-dark justify-content-center">
  <a href="#" class="navbar-brand mr-auto" style="color:white">Redcorp</a>
...
<div class="container-fluid">
  ...
  <div class="container-fluid row" style="margin-top:50px;">
    <div class="container col-md-10 row">
      <?php
        ...
        function crearCardVendedor($nombre_vendedor, $foto_vendedor){
          echo '<div class="card" style="width: 16rem; margin: 10px 30px;">
            <img class="card-img-top desvanecer" src="img/'.$foto_vendedor.'" alt="">
    ...
    <div class="container-fluid col-md-2 justify-content-center py-4">
